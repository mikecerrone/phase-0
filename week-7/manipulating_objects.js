...
var adam={name:"Adam", spouse:terah}
terah.spouse = adam;
terah.weight = 125;
terah.children ={}
...
// - What tests did you have trouble passing? What did you do to make it pass? Why did that work?
    // --- It was tough figuring out how to add new elements to objects without editing the original object. I researched and found the correct syntax and it now makes perfect sense to me.
// - How difficult was it to add and delete properties outside of the object itself?
    // --- very easy! just using the delete element and naming the object and the property
// - What did you learn about manipulating objects in this challenge?
    // --- objects are very simply manipulated. I addition, they are very dynamica and can be nested and edited from outside the orignial object with ease.
//
//
//
//
